...
namespace MedicaiFacility.Pages
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet(string? searchTerm, string option ="Facility" ,int pg=1, List<string>? selectedDepartments = null)
        {
            ...
            var listItem = _medicalFacilityService.GetAllMedicalFacility().OrderByDescending(x=>x.FacilityId).Where(x=>x.IsActive==true).ToList();
