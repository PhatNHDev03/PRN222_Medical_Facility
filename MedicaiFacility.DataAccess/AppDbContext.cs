...
public partial class AppDbContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA2034B568C");
			...
			entity.HasIndex(e => e.TransactionId, "UQ__Appointm__55433A4AF8445AC1").IsUnique();
		...
		{
			entity.HasKey(e => e.ConversationId).HasName("PK__Conversa__C050D897AF08FB53");
		...
		{
			entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD3F04CDD0");
		...
		{
			entity.HasKey(e => e.DiseaseId).HasName("PK__Diseases__69B533A9A7E0439F");
		...
		{
			entity.HasKey(e => e.FacilityDepartmentId).HasName("PK__Facility__A8D5DCC8D922B1E4");
		...
		{
			entity.HasKey(e => e.ArticleId).HasName("PK__HealthAr__9C6270C82EF795E4");
		...
		{
			entity.HasKey(e => e.RecordId).HasName("PK__HealthRe__FBDF78C90E921244");
		...
		{
			entity.HasKey(e => e.HealthRecordDiseaseId).HasName("PK__HealthRe__FC643971624EFBEB");
		...
		{
			entity.HasKey(e => e.ExpertId).HasName("PK__MedicalE__7EDB3A3863D545E7");
		...
		{
			entity.HasKey(e => e.ScheduleId).HasName("PK__MedicalE__9C8A5B697386DB05");
		...
		{
			entity.HasKey(e => e.FacilityId).HasName("PK__MedicalF__5FB08B94B4AD5448");
		...
		{
			entity.HasKey(e => e.HistoryId).HasName("PK__MedicalH__4D7B4ADDB4BA734D");

			entity.ToTable("MedicalHistory");

			entity.HasIndex(e => e.AppointmentId, "UQ__MedicalH__8ECDFCA36F626008").IsUnique();
		...
		{
			entity.HasKey(e => e.MessageId).HasName("PK__Messages__C87C037CBB7AE72E");
		...
		{
			entity.HasKey(e => e.PatientId).HasName("PK__Patients__970EC346EC655B95");
		...
		{
			entity.HasKey(e => e.FeedbackId).HasName("PK__RatingsA__6A4BEDF61F0BDF36");

			entity.ToTable("RatingsAndFeedback");

			entity.HasIndex(e => e.AppointmentId, "UQ__RatingsA__8ECDFCA35C01F619").IsUnique();
		...
		{
			entity.HasKey(e => e.BalanceId).HasName("PK__SystemBa__A760D59E47FB8713");
		...
		{
			entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A4B0866F893");

			entity.HasIndex(e => e.TransactionStatus, "IX_Transactions_TransactionStatus");

			entity.HasIndex(e => e.AppointmentId, "UQ__Transact__8ECDFCA37A8C1307").IsUnique();
		...
		{
			entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACA7C74659");

			entity.HasIndex(e => e.Email, "IX_Users_Email");

			entity.HasIndex(e => e.UserType, "IX_Users_UserType");

			entity.HasIndex(e => e.PhoneNumber, "UQ__Users__85FB4E3809194A7E").IsUnique();

			entity.HasIndex(e => e.Email, "UQ__Users__A9D10534F7D84142").IsUnique();
